...
Запуск сервера.
При клонировании репозитория с github:
...
1) Установите Python 3.10.4. Также проверял на 3.10.12, на остальных версиях работоспособность не гарантируется;
2) Убедитесь что установлен `python3-venv`, если нет - установите;
3) На основе вышеуказанной версии Python, создайте виртуальное окружение командой `python3 -m venv venv`;
...
При установке через `pip3`:
1) Установите Python 3.10.4. Также проверял на 3.10.12, на остальных версиях работоспособность не гарантируется;
2) Убедитесь что установлен `python3-venv`, если нет - установите;
3) На основе вышеуказанной версии Python,создайте виртуальное окружение командой `python3 -m venv venv`;
4) Активируйте виртуальное окружение командой `source venv/bin/activate`;
5) Установите пакет с серверной частью командой: `pip3 install cpu-utilization-monitoring`;
6) Далее создайте файл `main.py` со следующим содержимым:
    ```
    ...
    if __name__ == '__main__':
        main()
    ```
7) Выполните команду `python3 main.py migrate`;
8) Выполните команду `python3 main.py runserver SERVER_IP:SERVER_PORT`, где SERVER_IP - ip адресс сервера, SERVER_PORT - порт сервера. Для запуска на стандартных настройках выполните команду `python3 main.py runserver`.
